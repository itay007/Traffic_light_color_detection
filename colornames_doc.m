...
% requested palette:
[clr,rgb] = colornames('HTML4', [0.5,0.1,0.5; 0.9,0.9,0.1])
...
rgb = [0.384615384615385,0.615384615384615,1];
colornames('MATLAB',rgb,'CIEDE2000')
colornames('MATLAB',rgb,'CIE94') % default
colornames('MATLAB',rgb,'CIE76') % aka "Lab"
colornames('MATLAB',rgb,'CMCl:c')
colornames('MATLAB',rgb,'RGB')
...
colornames_deltaE('MATLAB',cool(16))
